...
func TestTerraform3bhk(t *testing.T) {
	t.Run("should be able to create with 3bhk", func(t *testing.T) {
	...
	t.Run("should be able to create 3bkh with default floor name", func(t *testing.T) {
		terraformOptions := terraform.WithDefaultRetryableErrors(t, &terraform.Options{
			TerraformDir: "../3bhk",
